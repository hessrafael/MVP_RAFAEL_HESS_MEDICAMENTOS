...
@app.put('/consome_medicamento',tags=[medicamento_tag])
def consume_quantity(form: MedicamentoConsomeRepoeQtdadeSchema):
    """Decrementa (consome) a quantidade de um dado medicamento
    """
    try:
        # criando conexão com o banco
        session = Session()
